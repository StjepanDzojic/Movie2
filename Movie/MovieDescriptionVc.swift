...
class MovieDescriptionVC: UIViewController {
    ...
    var movieDirectorNameLabel : UILabel = {
        let movieDirectorLabel = UILabel()
        movieDirectorLabel.numberOfLines = 0
        movieDirectorLabel.adjustsFontSizeToFitWidth = true
    ...
    override func viewDidLoad() {
        ...
        movieDirectorNameLabel.text = directorText
        ...
        view.addSubview(movieDirectorNameLabel)
    ...
    func setupDirectorName(){
        movieDirectorNameLabel.translatesAutoresizingMaskIntoConstraints = false
        movieDirectorNameLabel.topAnchor.constraint(equalTo: movieGenreLabel.bottomAnchor, constant: 7).isActive = true
        movieDirectorNameLabel.leadingAnchor.constraint(equalTo: movieDirectorLabel.trailingAnchor, constant:6).isActive = true
    ...
    func setupDescription(){
        ...
        movieDescriptionLabel.topAnchor.constraint(equalTo: movieDirectorNameLabel.bottomAnchor, constant: 7).isActive = true
